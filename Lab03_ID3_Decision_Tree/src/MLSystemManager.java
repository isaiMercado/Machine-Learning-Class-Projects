...
public class MLSystemManager {
	...
	public void run(String[] args) throws Exception {
            args = new String[]{"-L", "decisiontree", "-A", "../../twitter_sentiment_analysis_mining/march_without_dates.arff", "-E", "cross", "10", "-N"};
            //args = new String[]{"-L", "decisiontree", "-A", "data/lenses.arff", "-E", "training", "-N"};
