...
public class MLSystemManager {
	...
	{
            if (model.equals("knn")) return new KNearestNeighbor(true, 1);
            if (model.equals("rknn")) return new RegressionKNearestNeighbor(true, 15);
            throw new Exception("Unrecognized model: " + model);
	}

	public void run(String[] args) throws Exception {
            //args = new String[]{"-L", "rknn", "-A", "data/housing_training_set.arff", "-E", "training"}; 
            //args = new String[]{"-L", "knn", "-A", "data/credit.arff", "-E", "cross", "10", "-N"}; 
            args = new String[]{"-L", "rknn", "-A", "../../twitter_sentiment_analysis_mining/march_without_dates.arff", "-E", "static", "data/telescope_test_set.arff", "-N"}; // folds 10
            //args = new String[]{"-L", "perceptron", "-A", "data/nonLinearSeparable.arff", "-E", "training"}; 
