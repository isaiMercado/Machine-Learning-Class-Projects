...
public class MLSystemManager {
	...
	public SupervisedLearner getLearner(String model, Random rand) throws Exception
	{
                int hiddenLayers = 1;
                int hiddenNodes = 20;
		if (model.equals("neuralnet")) return new NeuralNetwork(hiddenLayers,hiddenNodes);
	...
	public void run(String[] args) throws Exception {
                ...
                args = new String[]{"-L", "neuralnet", "-A", "../../twitter_sentiment_analysis_mining/march_without_dates.arff", "-E", "cross", "10", "-N"};
