...
public class MLSystemManager {
	...
	public SupervisedLearner getLearner(String model, Random rand) throws Exception
	{
            ...
            else if (model.equals("perceptron")) return new Perceptron();//Perceptron(rand);
	...
	public void run(String[] args) throws Exception {
            // votingMissingValuesReplaced.arff "data/iris.arff"
            args = new String[]{"-L", "perceptron", "-A", "data/votingMissingValuesReplaced.arff", "-E", "cross", "4", "-N"}; // folds 10
            //args = new String[]{"-L", "perceptron", "-A", "data/iris_versicolor_virginica.arff", "-E", "cross", "2", "-N"}; // folds 10
